...
class GuruResource extends Resource
{
    ...
    {
        return [
            'index' => \App\Filament\Resources\Gurus\Pages\ListGurus::route('/'),
            'create' => \App\Filament\Resources\Gurus\Pages\CreateGuru::route('/create'),
            'edit' => \App\Filament\Resources\Gurus\Pages\EditGuru::route('/{record}/edit'),
        ];
    }
}
